...
public class HotelRepository {
   ...
   public Hotel findById(Long id) {
    ...
    Hotel findByPN(String hotelNumber) {
         ...
         criteria.select(hotel).where(cb.equal(hotel.get("hotelNumber"), hotelNumber));
    ...
    Hotel create(Hotel hotel) throws ConstraintViolationException, ValidationException, Exception {
        log.info("HotelRepository.create() - Creating " + hotel.getHotel() + " " + hotel.getHotelNumber() + " " + hotel.getHotelPostCode());
    ...
    Hotel update(Hotel hotel) throws ConstraintViolationException, ValidationException, Exception {
        log.info("HotelRepository.update() - Updating " + hotel.getHotel() + " " + hotel.getHotelNumber() + " " + hotel.getHotelPostCode());
    ...
    Hotel delete(Hotel hotel) throws Exception {
        log.info("HotelRepository.delete() - Deleting " + hotel.getHotel() + " " + hotel.getHotelNumber() + " " + hotel.getHotelPostCode());
