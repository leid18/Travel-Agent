...
public class HotelBookingRepository {
     ...
     */
/*    Taxi findRegistration(String registration) {
...
*/
    ...
    HotelBooking findByCustomerID(Long customerID) {
        ...
        Root<HotelBooking> booking = criteria.from(HotelBooking.class);
   ...
   List<HotelBooking> findByHotelID(Long hotelID) {
     TypedQuery<HotelBooking> query = em.createNamedQuery(HotelBooking.FIND_BY_HOTELID, HotelBooking.class).setParameter("hotelID", hotelID); 
        return query.getResultList();
    }
    
   HotelBooking findByDate(Date date) {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<HotelBooking> criteria = cb.createQuery(HotelBooking.class);
        Root<HotelBooking> booking = criteria.from(HotelBooking.class);
        // Swap criteria statements if you would like to try out type-safe criteria queries, a new feature in JPA 2.0.
   ...
   HotelBooking create(HotelBooking booking) throws ConstraintViolationException, ValidationException, Exception {
        log.info("BookingRepository.create() - Creating " + booking.getHotelID() + " " + booking.getDate());
   ...
   HotelBooking update(HotelBooking booking) throws ConstraintViolationException, ValidationException, Exception {
        log.info("BookingRepository.update() - Updating " + booking.getHotelID() + " " + booking.getDate());
   ...
   HotelBooking delete(HotelBooking booking) throws Exception {
        log.info("BookingRepository.delete() - Deleting " + booking.getHotelID() + " " + booking.getDate());
