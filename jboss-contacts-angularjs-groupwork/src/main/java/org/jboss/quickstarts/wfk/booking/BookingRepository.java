...
public class BookingRepository {
    ...
    List<Booking> findByFlightID(Long flightID) {
        TypedQuery<Booking> query = em.createNamedQuery(Booking.FIND_BY_FLIGHT, Booking.class).setParameter("flightID", flightID); 
        return query.getResultList();
    }
    /**
    ...
    Booking create(Booking booking) throws ConstraintViolationException, ValidationException, Exception {
        log.info("BookingRepository.create() - Creating " + booking.getCustomerID() + " " + booking.getDate());
    ...
    Booking update(Booking booking) throws ConstraintViolationException, ValidationException, Exception {
        log.info("BookingRepository.update() - Updating " + booking.getCustomerID() + " " + booking.getDate());
    ...
    Booking delete(Booking booking) throws Exception {
        log.info("BookingRepository.delete() - Deleting " + booking.getCustomer() + " " + booking.getDate());
